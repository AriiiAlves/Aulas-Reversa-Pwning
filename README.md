...
Olá! Esse repositório foi criado para ter materiais de apoio da frente de Engenharia Reversa/Pwning do grupo de cibersegurança Ganesh.
...
- GDB-GEF: [hello_world] - Use o GDB para navegar por esse programa simples.
